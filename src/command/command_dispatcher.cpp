...
CommandDispatcher::CommandDispatcher(DataStore &store, BlockingManager &blocking_manager, Config &config, PubSubManager &pubsub_manager)
    : m_store(store), m_blocking_manager(blocking_manager), m_config(config), m_pubsub_manager(pubsub_manager) {}
